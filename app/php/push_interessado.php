<?php
    ...
    $sql = "select gcm_key from jobexpert.solicitacao inner join jobexpert.usuarios on jobexpert.solicitacao.usuario_id = jobexpert.usuarios.id_usuario where id_solicitacao = $solicitacao";
    $res = mysql_query($sql);
